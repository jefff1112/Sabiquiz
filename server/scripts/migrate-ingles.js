// ============================================
// SCRIPT: MIGRAR PREGUNTAS DE INGLÉS (30 NIVELES)
// ============================================
require('dotenv').config();
const { pool, testConnection } = require('../config/database');

// Importar los niveles desde el archivo
const { levels } = require('../../materias/ingles-data.js');

async function migrateInglesQuestions() {
    console.log('🚀 MIGRANDO PREGUNTAS DE INGLÉS (30 NIVELES)');
    console.log('═══════════════════════════════════════════════\n');
    ...
    try {
        // 1. Obtener ID de la materia "Inglés"
        ...
        if (materiaRows.length === 0) {
            console.error('❌ Materia "Inglés" no encontrada');
        ...
        console.log(`📚 Materia encontrada: Inglés (ID: ${materiaId})`);

        // 2. Limpiar datos existentes de Inglés
        console.log('\n🗑️ Eliminando datos existentes de Inglés...');
        ...
        console.log('\n🎉 ¡MIGRACIÓN DE INGLÉS COMPLETADA!');
