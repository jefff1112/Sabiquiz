// ============================================
// SCRIPT: MIGRAR PREGUNTAS DE PROGRAMACIÓN (30 NIVELES)
// ============================================
require('dotenv').config();
const { pool, testConnection } = require('../config/database');

// Importar los niveles desde el archivo
const { levels } = require('../../materias/programacion-data.js');

async function migrateProgramacionQuestions() {
    console.log('🚀 MIGRANDO PREGUNTAS DE PROGRAMACIÓN (30 NIVELES)');
    console.log('═══════════════════════════════════════════════\n');
    ...
    try {
        // 1. Obtener ID de la materia "Programación"
        ...
        if (materiaRows.length === 0) {
            console.error('❌ Materia "Programación" no encontrada');
        ...
        console.log(`📚 Materia encontrada: Programación (ID: ${materiaId})`);

        // 2. Limpiar datos existentes de Programación
        console.log('\n🗑️ Eliminando datos existentes de Programación...');
        ...
        console.log('\n🎉 ¡MIGRACIÓN DE PROGRAMACIÓN COMPLETADA!');
