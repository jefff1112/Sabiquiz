// ============================================
// SCRIPT: MIGRAR PREGUNTAS DE LENGUAJE (30 NIVELES)
// ============================================
require('dotenv').config();
const { pool, testConnection } = require('../config/database');

// Importar los niveles desde el archivo
const { levels } = require('../../materias/lenguaje-data.js');

async function migrateLenguajeQuestions() {
    console.log('🚀 MIGRANDO PREGUNTAS DE LENGUAJE (30 NIVELES)');
    console.log('═══════════════════════════════════════════════\n');
    ...
    try {
        // 1. Obtener ID de la materia "Lenguaje"
        ...
        if (materiaRows.length === 0) {
            console.error('❌ Materia "Lenguaje" no encontrada');
        ...
        console.log(`📚 Materia encontrada: Lenguaje (ID: ${materiaId})`);

        // 2. Limpiar datos existentes de Lenguaje
        console.log('\n🗑️ Eliminando datos existentes de Lenguaje...');
        ...
        console.log('\n🎉 ¡MIGRACIÓN DE LENGUAJE COMPLETADA!');
