// ============================================
// SCRIPT: MIGRAR PREGUNTAS DE CIENCIAS (30 NIVELES)
// ============================================
require('dotenv').config();
const { pool, testConnection } = require('../config/database');

// Importar los niveles desde el archivo
const { levels } = require('../../materias/ciencias-data.js');

async function migrateCienciasQuestions() {
    console.log('🚀 MIGRANDO PREGUNTAS DE CIENCIAS (30 NIVELES)');
    console.log('═══════════════════════════════════════════════\n');
    ...
    try {
        // 1. Obtener ID de la materia "Ciencias"
        ...
        if (materiaRows.length === 0) {
            console.error('❌ Materia "Ciencias" no encontrada');
        ...
        console.log(`📚 Materia encontrada: Ciencias (ID: ${materiaId})`);

        // 2. Limpiar datos existentes de Ciencias
        console.log('\n🗑️ Eliminando datos existentes de Ciencias...');
        ...
        console.log('\n🎉 ¡MIGRACIÓN DE CIENCIAS COMPLETADA!');
