// ============================================
// SCRIPT: MIGRAR PREGUNTAS DE SOCIALES (30 NIVELES)
// ============================================
require('dotenv').config();
const { pool, testConnection } = require('../config/database');

// Importar los niveles desde el archivo
const { levels } = require('../../materias/sociales-data.js');

async function migrateSocialesQuestions() {
    console.log('🚀 MIGRANDO PREGUNTAS DE SOCIALES (30 NIVELES)');
    console.log('═══════════════════════════════════════════════\n');
    ...
    try {
        // 1. Obtener ID de la materia "Sociales"
        ...
        if (materiaRows.length === 0) {
            console.error('❌ Materia "Sociales" no encontrada');
        ...
        console.log(`📚 Materia encontrada: Sociales (ID: ${materiaId})`);

        // 2. Limpiar datos existentes de Sociales
        console.log('\n🗑️ Eliminando datos existentes de Sociales...');
        ...
        console.log('\n🎉 ¡MIGRACIÓN DE SOCIALES COMPLETADA!');
